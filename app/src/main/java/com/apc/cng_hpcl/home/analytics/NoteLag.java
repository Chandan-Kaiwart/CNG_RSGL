...
public class NoteLag extends AppCompatActivity {
    private WebView webView,webViewSummary;
    private LinearLayout linear_edit;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_note_lag);
        ...
        report.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startWebView(BASE_URL+"Report/luage_note_approve.php");
            }
        });
...
//                startWebViewSummary(BASE_URL+"Report/luage_note_approve.php");
//            }
//        });
        ...
        webViewSummary.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource(WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(NoteLag.this);
