...
public class EditCityGateStation extends Fragment {


    public EditCityGateStation() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_edit_city_gate_station, container, false);
