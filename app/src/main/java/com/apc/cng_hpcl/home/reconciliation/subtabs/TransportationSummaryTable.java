...
public class TransportationSummaryTable extends AppCompatActivity {
String username;
    @Override
...
//        setContentView(R.layout.activity_test);
        ...
        String[] column = {"Date","Filled at MGS", "Delivered to DBS",  "Sent at DBS","Loss during Transport"};
        int rl=row.length;
