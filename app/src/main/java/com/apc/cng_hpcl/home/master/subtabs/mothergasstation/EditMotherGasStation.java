...
public class EditMotherGasStation  extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager viewPager;
String username;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_edit_mother_gas_station);
        ...
        final EditMotherGasStationAdapter adapter = new EditMotherGasStationAdapter(this,getSupportFragmentManager(),
