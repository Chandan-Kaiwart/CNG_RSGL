...
public class MgsSummaryTable extends AppCompatActivity {
String username;
    @Override
...
//        setContentView(R.layout.activity_test);
        ...
        String[] column = {"Date","Supplied from CGS", "Handled at DBS",  "Sent at DBS","Loss at MGS"};
        int rl=row.length;
