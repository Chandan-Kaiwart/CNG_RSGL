...
public class MgsLevel extends AppCompatActivity {
    private WebView webView,webViewSummary;
    private LinearLayout linear_edit;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mgs_level);
        ...
        report.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startWebView(BASE_URL+"Report/luage_msg.php");
//                startWebView(BASE_URL+"Report/multiselect_sim_npcl.php");
        ...
        summary.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startWebViewSummary(BASE_URL+"Report/summary_luag_mgs.php");
            }
        });
        ...
        webViewSummary.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource(WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(MgsLevel.this);
