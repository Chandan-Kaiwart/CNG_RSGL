...
public class TurnAround extends AppCompatActivity {
    private WebView webView,webViewSummary;
    private LinearLayout linear_edit;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_turn_around);
        ...
        report.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startWebView(BASE_URL+"Report/luag_lcv_turnaround.php");
            }
        });
        ...
        webViewSummary.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource(WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(TurnAround.this);
