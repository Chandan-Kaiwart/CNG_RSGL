...
public class EditLcv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_edit_lcv);
        ...
        final EditLcvAdapter adapter = new EditLcvAdapter(this,getSupportFragmentManager(),
