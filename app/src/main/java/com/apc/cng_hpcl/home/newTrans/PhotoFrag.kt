...
class PhotoFrag : Fragment() {
    ...
    private lateinit var args:PhotoFragArgs
    private var type = -1
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
       ...
       //     verTv.text = "v" + BuildConfig.VERSION_NAME
            ...
            args= PhotoFragArgs.fromBundle(requireArguments())
    ...
    private fun ReportMultiPartRequest(
     ca: String, latlng: String, address: String, bp: Bitmap,args:PhotoFragArgs
    ) {
        pb.visibility = View.VISIBLE
        sub.isEnabled = false
        Log.d("MissionSlip>>>>", url)
        val action=PhotoFragDirections.actionPhotoFragToReadingFrag(username,lcv,transId,mgs,dbs)
        cap.isEnabled = false
            ...
            object : VolleyMultipartRequest(
               ...
               //     Log.d("RESP>>>err", error.toString())
                ...
                override fun getParams(): MutableMap<String, String> {
                    ...
                    inputs["transaction_id"] = args.transId
                    inputs["station_id"] = args.dbsId+args.mgsId

                    inputs["stage"] = args.stage.toString()
...
//        bindPreview(cameraProvider)
    ...
    private fun UploadImageRequest(
        name: String, latlng: String, address: String, bp: Bitmap,args:PhotoFragArgs
    ) {
